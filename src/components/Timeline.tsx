...
const experiences = [
  {
    ...
    description:
      "Developed a tool that allows users of a group to buy limited time items faster than others by monitoring the websites using HTTP requests. More info here.",
  },
  {
    id: 2,
    ...
    description:
      "Used Python + Flask to develop the software for a SaaS with a team of developers. More info here.",
  },
  {
    id: 3,
    ...
    description:
      "A SaaS start up I developed in my spare time that now has 200+ monthly paying users. Used Python + JS. More info here.",
  },
];
...
const TimelineItem: React.FC<TimelineItemProps> = ({ experience, side }) => {
  return (
    ...
    >
      <div
        className={`bg-transparent bg-transparent border border-grey rounded-lg p-6 `}
      >
        <h3 className="text-xl font-semibold mb-2">{experience.role}</h3>
        <h4 className="text-purple-300 text-purple-300 mb-4">
          {experience.company}
        </h4>
        <p className="text-purple-200 text-purple-200 mb-2">
          {experience.date}
        </p>

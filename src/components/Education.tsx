  ...
  return (
    <div id="education" className="relative min-h-screen py-20 text-white">
      <div className="max-w-6xl mx-auto px-6">
              ...
              >
                <div className="flex flex-wrap justify-between items-start mb-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-purple-300 text-lg font-semibold">{edu.school}</p>
                    <p className="text-gray-400">{edu.location}</p>
                  </div>
                  <div className="text-right">
                    <span className="text-purple-200 font-medium bg-purple-900/30 px-4 py-2 rounded-full inline-block mb-2">
                      {edu.date}
                    </span>
                    <p className="text-yellow-300 font-semibold">GPA: {edu.gpa}</p>
                  </div>
                </div>

                <p className="text-gray-200 mb-6 leading-relaxed">{edu.description}</p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {certifications.map((cert) => (
              ...
              >
                ...
                <p className="text-purple-300 font-semibold mb-2">{cert.issuer}</p>
        ...
        <div className="mt-16 bg-transparent border border-purple-500/30 rounded-lg p-8 blur-background2 shadow-xl">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-gray-200">
            <div>
              <h4 className="font-semibold text-purple-300 mb-2">Online Courses</h4>
            ...
            <div>
              <h4 className="font-semibold text-purple-300 mb-2">Workshops & Conferences</h4>
              <ul className="space-y-1 text-sm">
            ...
            <div>
              <h4 className="font-semibold text-purple-300 mb-2">Publications & Speaking</h4>
              <ul className="space-y-1 text-sm">

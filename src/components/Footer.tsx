...
import { FaGithub, FaHeart, FaReddit, FaLinkedin } from "react-icons/fa";
      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">{f.tagline}</p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-gray-300">{f.quickLinks}</h3>
        ...
        <div className="border-t border-white/10 pt-6 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
            <p className="mb-4 md:mb-0">© {currentYear} Kevin Chen. {f.allRightsReserved}</p>
            <p className="flex items-center">
              {f.madeWith} <FaHeart className="text-gray-400 mx-2" size={12} /> {f.using}
            </p>
          </div>
        </div>
      </div>

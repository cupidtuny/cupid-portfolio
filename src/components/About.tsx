  ...
  return (
    <div className="relative flex items-center justify-center h-screen">
      <div className="text-white px-6 md:px-12">
        <h2 className="text-center text-xl md:text-3xl font-bold mb-20 mt-0">
          Hi, my name is Liu Yuan
        </h2>
          ...
          <div className="bg-transparent rounded-lg shadow-lg px-5 py-6 sm:px-6 my-10 w-full max-w-3xl mx-auto border blur-background2 mt-0">
            ...
            <div className="space-y-6">
              <p className="text-gray-200">
                Hello, I am Liu Yuan and I have been working as a software
                developer for 6+ years while working or managing several
                websites and AI products. My goal is to start an amazing career
                where I can contribute to the best of my skills and efforts for
                the growth of the organization and the satisfaction of clients.
                I work efficiently, ensuring my code is clean, W3C valid,
                semantic, and easy to maintain. Let&apos;s collaborate and
              ...
              <div className="flex items-start flex-col">
                <div className="text-left">
                  ✅ Some of the skills I use now on the front-end:
                </div>
                <ul className="space-y-2 ml-2 my-2">
                  <li>
                    ✔ Language: JavaScript (ES5/ES6, Babel), Typescript, HTML5,
                    CSS3 with SCSS.
                  </li>
                  <li>
                    ✔ Frameworks: ReactJS(Gatsby/NextJS), Vue2/Vue3, Redux,
                    Vuex, Nuxt;
                  </li>
                  <li>
                    ✔ UI CSS Frameworks: Tailwind, React Suite, Material UI,
                    Bootstrap, Shadcn, Vuetify;
                  </li>
                ...
                <div className="text-left">
                  ✅ Some of the skills I use now on the back-end:
                </div>
                <ul className="space-y-2 ml-2 my-2">
